...
- Root community-health files (`CONTRIBUTING.md`, `GOVERNANCE.md`, `CODE_OF_CONDUCT.md`, `SUPPORT.md`, `SECURITY.md`, `.github/SECURITY.md`) are generated artifacts sourced from `website/docs/core/*.md`.
