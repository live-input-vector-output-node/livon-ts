---
title: OpenSSF Best Practices (Passing)
sidebar_position: 13
---
...
- contribution workflow and quality gates: [Contributing](./contributing)
- support channels and issue/discussion process: [Support and Feedback](./support)
- code-of-conduct policy: [Code of Conduct](./code-of-conduct)
...
- dependency/security scanning: `.github/workflows/snyk.yml` (GitHub dependency review), `.github/workflows/scorecards.yml`
