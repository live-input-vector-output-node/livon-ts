...
4. [@livon/client](/docs/packages/client) executes plugin-generated client APIs over WebSocket.
...
<Mermaid
  value={`
flowchart LR
  ClientApp["Client App"] --> Generated["@livon/generated physical files"]
  Generated --> ClientRuntime["@livon/client"]
  ClientRuntime --> WebSocket[WebSocket network]
