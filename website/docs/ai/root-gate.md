...
| `trusted-external-badges` | Repository badges must use trusted externally hosted sources; do not add generated or self-hosted badge artifacts, badge workspaces, or CI steps that publish local badge files. | docs review + CI/workflow review + gate review |
